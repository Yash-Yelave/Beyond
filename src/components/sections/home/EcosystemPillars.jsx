    ...
    <section className="bg-ivory py-20 lg:py-32">
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="max-w-[620px] mb-20">
          ...
          <h2 className="font-serif text-[40px] leading-[50px] lg:text-[52px] lg:leading-[60px] font-light text-primary mb-8 tracking-[-0.02em]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
          {pillars.map((pillar, idx) => (
            <motion.div
              ...
              className="bg-card p-10 lg:p-12 border border-border rounded-lg hover:-translate-y-2 transition-transform duration-500"
            >
              <div className="text-gold mb-8">
                {pillar.icon}
              </div>
              <h3 className="font-serif text-[26px] leading-[36px] font-light text-primary mb-6">
                {pillar.title}
              </h3>
