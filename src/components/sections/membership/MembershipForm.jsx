  ...
  return (
    <div className="bg-white border border-[#e2e8f0] rounded-2xl shadow-sm overflow-hidden">
      ...
      <div className="border-t border-[#e2e8f0] px-6 md:px-10 py-5 flex items-center justify-between bg-[#f8fafc]/50">
        ...
        {step < STEPS.length ? (
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={next} className="flex items-center gap-2 bg-[#0f172a] text-white px-6 py-2.5 rounded-xl text-sm font-semibold hover:bg-[#1e293b] transition-colors">
